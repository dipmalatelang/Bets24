...
public class PhoneActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinnerPhone.setAdapter(StateAdapter);
    ...
    @OnClick({R.id.tv_phone_title,  R.id.edit_number, R.id.btn_phone})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tv_phone_title:
                break;
    ...
    private void setPopup1() {
        ...
        try {
            ...
            ListPopupWindow StatepopupWindow = (ListPopupWindow) popup1.get(spinnerPhone);
